static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LEAGUE_ISLAND - 1] = {MAP_GROUP(LEAGUE_ISLAND), MAP_NUM(LEAGUE_ISLAND), 23, 22},
    [HEAL_LOCATION_PORTREE - 1] = {MAP_GROUP(PORTREE), MAP_NUM(PORTREE), 22, 13},
    [HEAL_LOCATION_BOLSHAN_CITY - 1] = {MAP_GROUP(BOLSHAN_CITY), MAP_NUM(BOLSHAN_CITY), 13, 31},
    [HEAL_LOCATION_SHILLFORD - 1] = {MAP_GROUP(SHILLFORD), MAP_NUM(SHILLFORD), 27, 20},
    [HEAL_LOCATION_ROCKDALE - 1] = {MAP_GROUP(ROCKDALE), MAP_NUM(ROCKDALE), 22, 15},
    [HEAL_LOCATION_SANDFIELD - 1] = {MAP_GROUP(SANDFIELD), MAP_NUM(SANDFIELD), 12, 13},
    [HEAL_LOCATION_WADDENS_COVE - 1] = {MAP_GROUP(WADDENS_COVE), MAP_NUM(WADDENS_COVE), 17, 21},
    [HEAL_LOCATION_ARRINA_TOWN - 1] = {MAP_GROUP(ARRINA_TOWN), MAP_NUM(ARRINA_TOWN), 9, 11},
    [HEAL_LOCATION_DUNNING_HILL - 1] = {MAP_GROUP(DUNNING_HILL), MAP_NUM(DUNNING_HILL), 16, 13},
    [HEAL_LOCATION_DONKIN_TOWN - 1] = {MAP_GROUP(DONKIN_TOWN), MAP_NUM(DONKIN_TOWN), 17, 23},
    [HEAL_LOCATION_CAPE_SKAW - 1] = {MAP_GROUP(CAPE_SKAW), MAP_NUM(CAPE_SKAW), 15, 18},
    [HEAL_LOCATION_CORRIN_ISLAND - 1] = {MAP_GROUP(CORRIN_ISLAND), MAP_NUM(CORRIN_ISLAND), 23, 27},
    [HEAL_LOCATION_MIRA_RIVER - 1] = {MAP_GROUP(MIRA_RIVER), MAP_NUM(MIRA_RIVER), 17, 24},
    [HEAL_LOCATION_CANTERBURY_TOWN - 1] = {MAP_GROUP(CANTERBURY_TOWN), MAP_NUM(CANTERBURY_TOWN), 37, 28},
};
